...
def fly_games(first: int = 6000, last: int = 6016, control: str = "none", mines: int = 10, opening_radius: int = 1):
    run("/root/scripts/fly_games.py", str(first), str(last), control, str(mines), str(opening_radius))
